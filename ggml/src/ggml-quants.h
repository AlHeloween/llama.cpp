...
/* BitNet I2_S: 2-bit ternary (-1, 0, +1), 4 values per byte. 00=-1, 01=0, 10=+1, 11=0. */
GGML_API void dequantize_row_i2_s(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
